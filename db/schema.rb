...
ActiveRecord::Schema.define(version: 20160330210850) do
  ...
  add_index "application_submissions", ["applicant_id", "opening_id"], name: "index_application_submissions_on_applicant_id_and_opening_id", unique: true, using: :btree
